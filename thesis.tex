...
\newcommand{\custriangle}{\includegraphics[scale=0.5]{Chapter-Rank/figures/upsidedown.png}}
\newcommand{\cuscross}{\includegraphics[scale=0.4]{Chapter-Rank/figures/cross.png}}
\newcommand{\cusdot}{\includegraphics[scale=0.5]{Chapter-Rank/figures/dot.png}}
...
\lstset{
    ...
    emph={furthest,gale,better,improved,where,fastmap,split,project,mutate,mutate1, progressive, build_model, test_model, rank_based, projective, measure, progressive, build_model, rank_based, projective, measure, acquisition_function, stopping_criterion, recombine, selector, init_population, EA, SWAY, cluster, split, BayesianOpt, ePAL, GO, model_predict, discard, get_next_point, predict, non_dominated_sort, assign_cdom_scores, FLASH, acquisition_fn, BarrySort }, emphstyle=\bfseries\color{blue!50!black},
...
\lstset{
    ...
    showstringspaces=false,
    keywordstyle=\bfseries\sffamily,
    emph={progressive, build_model, test_model, rank_based, projective, measure}, emphstyle=\bfseries\color{blue!50!black},
    stringstyle=\color{green!50!black},
    commentstyle=\color{red!50!black}\it,
    numbers=left,
    captionpos=t,
...
\memberII{Dr. Min Chi}
\memberIII{Dr. Ranga Raju Vatsavai}   % unnecessary if committeesize=3
