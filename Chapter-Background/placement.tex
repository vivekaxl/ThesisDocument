...
two replicas in another rack for \rone{system reliability}.
...
\rone{
In addition, data placement is considered
a factor that affects system performance.
Previous work optimizes data placement to improve performance
in heterogeneous Hadoop clusters~\cite{Xie2010}.
CoHadoop is another attempt to improve MapReduce efficiency
by co-locating data as suggested by MapReduce applications~\cite{Eltabakh2011}.
}
...
NoSQL databases are popular repositories for large-scale data
